...
/**
 *
 * Plugin Name: Popups - Wordpress Popups
 * Plugin URI: http://www.timersys.com/free-plugins/popups/
 * Version: 1.0.0
...
<p style="text-align: center;">[spu-facebook][spu-google][spu-twitter]</p>';
	...
	function facebook_shortcode( $atts, $content ) {
		...
		return '<script>(function(d, s, id) {
            ...
            }(document, \'script\', \'facebook-jssdk\'));</script><div class="spu-facebook spu-shortcode"><div class="fb-like" data-width="'.$width.'" data-href="'.$href.'" data-layout="'.$layout.'" data-action="'.$action.'" data-show-faces="'.$show_faces.'" data-share="'.$share.'"></div></div>';
